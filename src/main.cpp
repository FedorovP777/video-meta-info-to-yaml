...
void handleFile(YAML::Emitter *outYaml, const filesystem::path &file) {
...
int main() {
    ...
    for (auto &range:ranges) {
        tasks.push_back(std::async(std::launch::async, [&range, &files, &fileNameCounter, &i]() {
